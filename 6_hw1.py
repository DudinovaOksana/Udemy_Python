...
#Класс должен приводить переданные имя и фамилию в форму при которой имя и фамилия начинаются
# с заглавной буквы, а все остальные буквы в нижнем регистре (поскольку вызывающий код может
# передавать такие строки как "JOHN", 'jOHN', 'sMiTh' и т.д.)
#Примеры вызовов:
#a1 = Name('john', 'SMITH')
#a1.first_name ➞ 'John'
#a1.last_name ➞ 'Smith'
